        ...
        <section class="section-bottom">
            <p class="nama-akun">Jurnal Umum</p>
                ...
                <ul >
                    ...
                    <li>
                        <a href="neraca.php" class="menu-bottom" style="color: #000000;">
        ...
        <main>
            <table>
                ...
                <tr>
                    ...
                    <td><a a href="Neraca.pdf" target="blank"><img style="width:34px; height:34px;" src="../img/icon_print.png"></a></td>
                </tr>
                <tr>
                    <td><a href="#" style="text-decoration: none;"><p class="edit">ubah</p></a></td>
                    <td><a href="#" style="text-decoration: none;"><p class="edit">Tampilkan</p></a></td>
