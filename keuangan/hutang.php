        ...
        <section class="section-bottom">
            ...
            <nav class="nav-top">
                <ul >
                    ...
                    <li>
                        <a href="hutang.php" class="menu-bottom" style="color: #000000;">
        ...
        <main>
            <table>
                ...
                <tr>
                    ...
                    <td><a a href="Hutang.pdf" target="blank"><img style="width:34px; height:34px;" src="../img/icon_print.png"></a></td>
                </tr>
                <tr>
                    <td><a href="#" style="text-decoration: none;"><p class="edit">ubah</p></a></td>
                    <td><a href="#" style="text-decoration: none;"><p class="edit">Tampilkan</p></a></td>
                ...
                <tr>
                    ...
                    <td></td>
                    <td><p class="sesuai">Sesuai</p></td>
                    <td><aa href="Hutang.pdf" target="blank"><img style="width:34px; height:34px;" src="../img/icon_print.png"></a></td>
                </tr>
                <tr>
                    <td><a href="#" style="text-decoration: none;"><p class="edit">ubah</p></a></td>
                    <td><a href="#" style="text-decoration: none;"><p class="edit">Tampilkan</p></a></td>
