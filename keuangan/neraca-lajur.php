    ...
    <body>
        ...
        <section class="section-bottom">
            ...
            <nav class="nav-bottom" style="float: left;  width: 43%;">
                <ul >
                    <li>
                        <a href="neraca-lajur.php" class="menu-bottom" style="color: #000000;">
        ...
        <main>
            <table>
                ...
                <tr>
                    ...
                    <td><a a href="Neraca Lajur.pdf" target="blank"><img style="width:34px; height:34px;" src="../img/icon_print.png"></a></td>
                </tr>
                <tr>
                    <td><a href="#" style="text-decoration: none;"><p class="edit">ubah</p></a></td>
                    <td><a href="#" style="text-decoration: none;"><p class="edit">Tampilkan</p></a></td>
