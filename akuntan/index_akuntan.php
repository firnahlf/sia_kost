        ...
        <aside class="rectangle-70">
            ...
            <nav style="margin-left: -60px; margin-right: -60px;">
                <ul>
                    ...
                    <a href="../admin/kelola_user" class="menu">
                        <li class="padding-menu">
            ...
            <nav style="float: left;  width: 65.5%; margin-top: -15px;">
                <ul >
                    <li style="margin-right: 30px;">
                        <a href="index_akuntan.php" class="menu" style="color: #000000;">
        ...
        <main>
            <table>
                <tr>
                    ...
                    <th style="background-color: #dfdfdf; font-weight: bold; width: 13%;">Data</th>
