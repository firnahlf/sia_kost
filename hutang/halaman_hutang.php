...
<html lang="en">
    ...
    <body>
        ...
        <section class="section-akun">
            ...
            <nav>
                <ul>
                    ...
                    <li>
                    <a href="inputhutang.php" class="menu" style="color: #dddddd;">
        ...
        <table id="transaksi">
            ...
            $baca = mysqli_query($koneksi, "SELECT * FROM hutang");
            while( $tampil = mysqli_fetch_array($baca))
            {
              ?>
            <tr>
                <td><a href="edit_hutang.php" style="text-decoration: none;"><p class="edit">ubah</p></a></td>
                <td><a href="delete_hutang.php?id=<?php echo $tampil['id_hutang']; ?>" style="text-decoration: none;"><p class="edit">hapus</p></a></td>
                <td><?php echo $tampil['id_hutang'] ; ?></td>
                <td><?php echo $tampil['tgl_transaksi_htng'] ; ?></td>
                <td><?php echo $tampil['deskripsi'] ; ?></td>
                <td><?php echo $tampil['jumlah_hutang'] ; ?></td>
            </tr>
