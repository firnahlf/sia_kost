...
<html lang="en">
    ...
    <body>
        <aside class="rectangle-70">
            ...
            <nav style="margin-left: -60px; margin-right: -60px;">
                <ul>
                    ...
                    <a href="../kasir/index_transaksi.php" class="menu">
                        <li class="padding-menu">
        ...
        <section class="section-akun">
            ...
            <a href="input_akun.php" ><img class="button-section" style="width:34px; height:34px;" src="../img/icon_add.png"></a>
        ...
        <main>
            ...
            <tr>
                ...
                <th style="background-color: #dfdfdf; font-weight: bold; width: 85%; border-top-right-radius: 10px;">Nama Akun</th>
            </tr>
            <?php
            include "../include/koneksi.php";
            $baca = mysqli_query($koneksi, "SELECT * FROM akun");
            while( $tampil = mysqli_fetch_array($baca))
            {
            ?>
            <tr>
                <td><a href="edit_akun.php" style="text-decoration: none;"><p class="edit">Ubah</p></a></td>
                <td><a href="delete_akun.php" style="text-decoration: none;"><p class="edit">Hapus</p></a></td>
