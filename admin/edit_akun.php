...
<html lang="en">
    ...
    <body>
            ...
            <nav style="float: left;  width: 52%; margin-top: -15px;">
                <ul >
                    <li style="margin-right: 30px;">
                        <a href="index_admin.php" class="menu" style="color: #000000">
                            <p class="text-menu">Kelola Akun</p>
                        </a>
                    </li>
                    <li style="margin-right: 30px;">
                        <a href="kelola_user.php" class="menu" style="color: #dddddd;">
      ...
      $id_akun = isset($_GET['id_akun']);
      $query = mysqli_query($koneksi, "SELECT * FROM akun WHERE id_akun ='$id_akun'");
      $tampil = mysqli_fetch_array($query);
      ?>
        <main>
            <form class="form-kasir" action="proses_edit_akun.php" method="post">
               <p class="name-main">Ubah Akun</p>
                <div class="group-akun">
                    <label>Kode Akun</label>
                    <br>
                    <input class="input-user" type="text" name="id_akun" value="<?php echo $tampil['id_akun'] ;?>" >
                    <input class="input-user" name="id_akun" type="hidden" value="<?php echo $tampil['id_akun'] ;?>">
                </div>
                <div class="group-akun">
                    <label>Nama Akun</label>
                    <br>
                    <input class="input-user" type="email" name="nama_akun" value="<?php echo $tampil['nama_akun'] ;?>">
                    <input class="input-user" name="nama_akun" type="hidden" value="<?php echo $tampil['nama_akun'] ;?>">
                </div>
                <br>
                <a href="index_admin.php"><button class="btn-input">BATAL</button></a>
