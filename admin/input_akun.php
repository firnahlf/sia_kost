...
<html lang="en">
    ...
    <body>
        ...
        <section class="section-akun">
            ...
            <nav style="float: left;  width: 60%; margin-top: -15px;">
                <ul >
        ...
        <main>
            <form class="form-kasir" action="proses_simpan_akun.php" method="post">
                <p class="name-main">Input Akun</p>
                <div class="group-akun">
                    <label>Kode Akun</label>
                    <br>
                    <input class="input-user" type="number" name="no_akun" required="required">
                </div>
                <div class="group-akun">
                    <label>Nama Akun</label>
                    <br>
                    <input class="input-user" type="text" name="nama_akun" required="required">
                </div>
                <br>
                <a href="index_admin.php">
                <button class="btn-input">BATAL</button>
                </a>
